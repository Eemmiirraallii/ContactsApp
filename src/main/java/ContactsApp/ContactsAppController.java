...
public class ContactsAppController {
    ...
    public void initialize() {
        this.contacts.add(new Contact("Emir", "Abaskanov", "EmirAbaskanov@gmail.com", "+0312312312"));
        this.contacts.add(new Contact("Dariga", "Abaskanova", "DarigaAbaskanova@gmail.com", "+707707707"));
        this.contacts.add(new Contact("Aziz", "Bektemirova", "AzizBektemirova@gmail.com", "+505505505"));
